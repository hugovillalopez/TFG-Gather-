...
export default function Login(){
    ...
    return (
        ...
        <div className="h-screen md:flex overflow-hidden">
            ...
            <div className="flex md:w-1/2 justify-center  h-full items-center">
                <form className="" ref={formRef} onSubmit={Loggear}>
                    <h1 className="text-gray-800 font-bold text-2xl mb-1 dark:text-gray-300">Hola!</h1>
                    <p className="text-sm font-normal text-gray-600 mb-7 dark:text-gray-400">Bienvenido</p>
                    ...
                    <span onClick={() => router.push("/olvidadaPassword/")} className="text-sm ml-2 hover:text-orange-500 cursor-pointer">Forgot Password ?</span>
